...
PYBIND11_MODULE(DataFrameWrapper, m) {
    ...
    py::class_<Toolbox::dfw::DataFrameWrapper<int>>(m, "DataFrameWrapper")
        .def(py::init<>())
        ...
        /* .def("columns_by_name", &Toolbox::dfw::DataFrameWrapper<int>::template columns<int>, */
        /*      py::arg("columnName"), */
        ...
        /* .def("columns_by_index", &Toolbox::dfw::DataFrameWrapper<int>::template columns<int>, */
        /*      py::arg("col_index"), */
...
/* py::arg("col_index"), */
        ...
        /* .def("columns_by_entry", &Toolbox::dfw::DataFrameWrapper<int>::template columns<int>, */
        ...
        /* .def("columns_by_slice", &Toolbox::dfw::DataFrameWrapper<int>::template columns<double>, */
